...
| [08_vercel](08_vercel/) | Vercel 배포 설정 |
| [09_claude_web](09_claude_web/) | Claude로 웹 페이지 생성 실습 (계획 유무, 프론트엔드 디자인 스킬, Haiku 등 단계별 비교) |
| [10_anaconda](10_anaconda/) | Anaconda/pip 가상환경 및 패키지 관리 (pipreqs 등) |
| [11_python](11_python/) | 파이썬 기초 학습 (변수~람다, 17개 단원) |
| [12_data](12_data/) | Pillow/OpenCV 기반 이미지 데이터 수집·증강 |
| [13_YOLO](13_YOLO/) | Ultralytics YOLO11 실습 (탐지·분류·분할·포즈·카운팅·실시간 추적) |
...
6. **08_vercel → 09_claude_web** : 프로젝트 배포와 AI 기반 웹 페이지 생성 실습
7. **10_anaconda → 11_python** : 파이썬 개발 환경 구성과 기초 문법
8. **12_data → 13_YOLO** : 이미지 데이터 수집/증강과 YOLO11 객체 탐지·추적
