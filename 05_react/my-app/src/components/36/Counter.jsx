...
const Counter = () => {
  ...
  return (
    <div className="flex min-h-40 flex-col items-center justify-center gap-3">
      <span className="text-xs font-medium tracking-wide text-gray-400 uppercase">Count</span>
      <button
        onClick={() => setCount(c => c + 1)}
        className="min-w-32 rounded-xl bg-emerald-600 px-6 py-3 text-2xl font-bold text-white shadow-md transition hover:bg-emerald-700 active:scale-95"
      >
        {count}
      </button>
    </div>
